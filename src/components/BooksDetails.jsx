...
const BooksDetails = () => {
    ...
    return (
        <div className='my-container'>
            <div className='border max-w-screen-lg mx-auto flex flex-col md:flex md:flex-row md:items-center lg:items-start'>
                <img className='md:w-1/2 h-full object-cover' src={image} alt="book cover" />
